...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'hospital_v', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\User\\AdminBundle\\Entity'))), 'User\\AdminBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('UserAdminBundle' => 'User\\AdminBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_54614f88f32233af65d7102b8162a8a470b119ae39d62cd60a6053da43157543');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('User\\AdminBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('User\\AdminBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('User\\AdminBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('User\\AdminBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'User\\AdminBundle\\Entity\\User');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\User\\AdminBundle/Resources/views'), 'UserAdmin');
        $instance->addPath(($this->targetDirs[3].'\\src\\User\\PatientBundle/Resources/views'), 'UserPatient');
        $instance->addPath(($this->targetDirs[3].'\\src\\User\\MedcienBundle/Resources/views'), 'UserMedcien');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'UserAdminBundle' => 'User\\AdminBundle\\UserAdminBundle',
                'UserPatientBundle' => 'User\\PatientBundle\\UserPatientBundle',
                'UserMedcienBundle' => 'User\\MedcienBundle\\UserMedcienBundle',
            ...
            'fos_user.model.user.class' => 'User\\AdminBundle\\Entity\\User',
